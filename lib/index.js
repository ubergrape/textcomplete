...
Textcomplete.prototype.match = function () {
  var el = this.el
  var text = (this.is_textarea) ? el.value : el.innerText
...
Textcomplete.prototype.select = function (option) {
  ...
  var index = (this.is_textarea) ? el.selectionEnd : document.getSelection().anchorOffset
  var text = (this.is_textarea) ? el.value : el.innerHTML
