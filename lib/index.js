...
Textcomplete.prototype.match = function () {
  ...
  var start = (this.is_textarea) ? el.selectionStart : document.getSelection().extentOffset // cursor start
...
Textcomplete.prototype.select = function (option) {
  ...
  var text = (this.is_textarea) ? el.value : el.innerHTML.replace('&nbsp;', String.fromCharCode(160))
  var index = (this.is_textarea) ? el.selectionEnd : text.indexOf(this.caret.textBefore()) + this.caret.textBefore().length
